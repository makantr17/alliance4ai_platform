...
Route::post('/user/{topic}/addcontent', [ContentController::class, 'upload']);
...
Route::get('/user/{topic}/addexercise', [ExerciseController::class, 'createExercise'])->name('users.addexercise');
