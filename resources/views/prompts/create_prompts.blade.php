                ...
                <div class="row g-5 py-3 mx-2 justify-content-center">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <form class="row g-3 needs-validation d-flex flex-row align-items-center justify-content-center"
                            novalidate action="{{ route('users.addprompt',  $topic ) }}" method="post" enctype="multipart/form-data">
                            
                            @csrf
                            <div class="col-12">
                                <h5 class="py-4 fw-bold text-info">New Prompt Question</h5>
                            </div>
                            
                            <div class="col-md-12">
                                <label for="question" class="form-label">Write down the question add the question mark at the end.</label>
                                <textarea class="form-control py-2  rounded-lg @error('question') border border-danger @enderror" name="question" id="question" cols="30" rows="5" value=""></textarea>
