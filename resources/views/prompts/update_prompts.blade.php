            ...
            <div class="">
                <div class=" d-flex flex-wrap align-items-center px-0 pt-0">
                    @auth
                        ...
                        <form action="{{ route('users.topics.manage', [auth()->user()->name, $prompt->topic->id]) }}" method="get" class="mr-1">
                        @csrf
                ...
                <div class="col-md-12 col-lg-12">
                    <form class="row g-3 needs-validation d-flex flex-row align-items-center justify-content-center"
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('users.topics.manage', [auth()->user()->name, $prompt->topic->id]) }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
