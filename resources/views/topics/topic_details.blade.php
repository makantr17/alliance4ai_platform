    ...
    <div class="container-fluid mt-20">
        <div class="row align-items-center justify-content-center">
            ...
            @if ($topics -> count())
                ...
                <a href="" class="list-group-item list-group-item-action border d-block gap-3 py-2 m-2 bg-light " aria-current="true">
                    <div class="d-block justify-content-center overflow-hidden mb-2" style="max-height: 35vh;">
                        @if ($topic -> image)
                            <img src="{{ '/storage/images/topic/'.$topic->topic.'/'.$topic->image }}" alt="twbs" width="" height="" class="rounded flex-shrink-0 ">
                        @else
                    ...
                    <div class="d-flex gap-2 w-100 justify-content-between">
                        <div>
                            @if ($topic->user->image)
                                <img src="{{ '/storage/images/'.$topic->user->id.'/'.$topic->user->image }}" alt="twbs" width="45" height="45" class="rounded-circle flex-shrink-0 border">
                            @else
                                <img src="/images/icon-alliance/message.png" alt="twbs" width="45" height="45" class="rounded-circle flex-shrink-0 shadow-sm ">
                            @endif
