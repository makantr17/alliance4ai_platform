        ...
        @if ($exercise->topic)
            <div class="mb-4">
                <div class="container-fluid">
                    <h4 class="display-7 py-1 fw-bold ">{{ $exercise-> topic-> topic}}</h4>
                    <p style="font-size: 14px"><strong class="text-primary">Description </strong><br> {{ $exercise-> topic-> description}}</p>
                    <p><small>hosted by</small> <small class="text-info">{{ $exercise-> topic-> user->name}}</small></p>
                </div>
            </div>
        @endif
            ...
            <div class="row g-5 py-3 mx-2 justify-content-center">
                ...
                <div class="col-md-12 col-lg-12">
                    <form class="row g-3 needs-validation d-flex flex-row align-items-center justify-content-center"
                        novalidate action="{{ route('users.updateexercise',  [auth()->user(), $exercise]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            class="form-control py-2  rounded-lg @error('question') border border-danger @enderror" value="{{ $exercise->question }}">
