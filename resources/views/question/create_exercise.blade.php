                ...
                <div class="row g-5 py-3 mx-2 justify-content-center">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <form class="row g-3 needs-validation d-flex flex-row align-items-center justify-content-center"
                            novalidate action="{{ route('users.addexercise', [auth()->user(), $topic]) }}" method="post" enctype="multipart/form-data">
                            
                            @csrf
                            <div class="col-12">
                                <h5 class="py-4 fw-bold text-info">New Exercise</h5>
                            </div>
                            
                            <div class="col-md-12">
                                <label for="question" class="form-label">Write down the exercise</label>
