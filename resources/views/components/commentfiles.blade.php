...
<div class="row no-gutters align-items-center border my-2 p-2 rounded-2 bg-white ">
    <div class="d-none d-md-block col-3">
        <div class="row no-gutters align-items-center">
            <div class="align-items-center"> 
                @if ($commentfiles ->user->image)
                    <img class="d-block rounded-circle p-1 border border-info" width="45" height="45" src="{{ '/storage/images/'.$commentfiles->user_id.'/'.$commentfiles -> user ->image}}" alt="12">
                @else
                ...
                <div class="media-body flex-truncate">
                    <a href="" class="text-muted small text-center" data-abc="true">{{ $commentfiles->user->name }}</a>
                </div>
            </div>
        </div>
    </div>
