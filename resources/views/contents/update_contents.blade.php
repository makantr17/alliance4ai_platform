            ...
            <div class="">
                <div class=" d-flex flex-wrap align-items-center px-0 pt-0">
                    @auth
                        ...
                        <form action="{{ route('users.topics.manage', [auth()->user(), $content->topic->id]) }}" method="get" class="mr-1">
                        @csrf
...
<div class="col-lg-12 row y-1">
    <div class="col-lg-3 mx-2 bg-light py-2">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('topics.details', [$content->topic_id]) }}" method="get" >
            @csrf
                    ...
                    <div class="col-md-12 col-lg-12">
                        <form class="row g-3 needs-validation d-flex flex-row align-items-center justify-content-center"
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('users.topics.manage', [auth()->user(), $content->topic->id]) }}" class="btn btn-danger">Cancel</a>
                            </div>
